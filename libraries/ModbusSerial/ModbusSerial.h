...
class ModbusSerial : public Modbus {
    private:
        ...
        byte  _slaveId;
		uint32_t _receive_time;
		
		// preTransmission callback function; gets called before writing a Modbus message
    	void (*_preTransmission)();
		// postTransmission callback function; gets called at the start and after a Modbus message has been sent
    ...
    public:
        ModbusSerial(bool balance = false);
		void preTransmission(void (*)());
    	void postTransmission(void (*)());
        bool setSlaveId(byte slaveId);
        byte getSlaveId();
        void config(Stream* port, uint32_t baud);
        void task();
